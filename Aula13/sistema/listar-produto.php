    ...
    <div class="container">
        ...
        <table class="table table-bordered table-hover table-striped table-sm align-middle text-center">
            ...
            <tr>
                ...
                <td id="colunaImagem">  
                    <img class="imagemProduto" src="<?php echo $imagem ?>" alt="imagem">  
                </td> <!-- table data -->
                ...
                <td>
                    ...
                    <a class="btn btn-sm btn-warning" href="deletar-produto.php?id=<?php echo $id_estoque?>" role="button">Excluir</a>
                </td>
            <?php 
                }
            ?>
